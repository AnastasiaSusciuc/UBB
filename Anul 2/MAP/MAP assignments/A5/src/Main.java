...
public class Main {
    public static void main(String[] args) throws IOException, RepositoryException, ControllerException {
        ...
        PrgState prg10 = new PrgState(new MyStack<>(), new MyDictionary<String, IValue>(),  new MyList<IValue>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), example_10);
        IRepository repo10 = new Repository(prg10, "log-1.txt");
