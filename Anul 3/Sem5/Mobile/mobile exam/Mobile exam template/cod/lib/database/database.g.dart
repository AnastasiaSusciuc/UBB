    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `MyEntity` (`id` INTEGER, `name` TEXT, `description` TEXT, `ingredients` TEXT, `instructions` TEXT, `category` TEXT, `difficulty` TEXT, PRIMARY KEY (`id`))');
...
class _$MyEntityDao extends MyEntityDao {
  ...
  @override
  Future<List<MyEntity>> findAllMyEntitys() async {
